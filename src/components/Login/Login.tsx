...
const LoginForm: React.FC<
  InjectedFormProps<LoginFormValuesType, LoginOwnFormProps> & LoginOwnFormProps
...
const Login: React.FC<PropsType> = ({ captchaUrl, isAuth, login, getCaptchaUrl }) => {
